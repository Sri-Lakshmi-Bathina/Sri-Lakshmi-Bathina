...
- 🎓 M.S. in Data Science (UMass Dartmouth, 2025) and B.Tech in Computer Science (2023).  
- 🧮 Hands-on experience with ETL/ELT, PySpark, AWS, SQL, and machine learning in academic and internship settings.  
- 📊 Delivered projects that reduced model runtime by ~60%, saved 10+ hours/week of manual reporting, and reached ~87% accuracy in AI diagnostics.  
- 🎯 Target roles: <b>Data Scientist, Data Engineer, ML Engineer, Analytics Engineer</b>.  
- 🌱 Currently preparing for <b>AWS AI Practitioner</b> to deepen cloud + AI expertise.  
...
- 💼 LinkedIn: <a href="https://www.linkedin.com/in/srilakshmibathina">srilakshmibathina</a>  
- 🗂️ Explore pinned projects below for detailed code, notebooks, and dashboards.  
